...
const bot = new Telegraf("6447729016:AAEEzkQWuZufPfvnOpigJvxuhdGmUPonr3A");

bot.start(ctx => ctx.reply("Welcome to the new coding bot from Nikhil"));

bot.command("binarysearchjs", ctx => ctx.reply(binarysearch));
bot.command("whomadethis", ctx => ctx.reply("Nikhil-Arjun"));
